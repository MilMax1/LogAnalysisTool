...
SCENARIOS_TO_RUN = {"scenario_03", "scenario_04", "scenario_08", "scenario_09"}


def extract_json(text: str) -> dict:
    """
    Försöker tolka LLM-output som JSON.
    Hanterar även fall där modellen råkar lägga JSON i markdown-code fence.
    """
    cleaned = text.strip()
